...
Pakiet pozwala na wyznaczanie emisji pochodzacej z transportu wedlug sposobu opisanego w podreczniku wydanym przez Europejska Agensje Srodowiska - EEA. Pakiet sklada sie z dwoch funkcji: - obl_emisja() <- obliczanie emisji na podstawie dostarczonyc danych, - wykres_emisja() <- wizualizacja danych.
